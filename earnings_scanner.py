...
def _format_play_message(play, risk_cfg, narrative):
    ...
    lines += [
        ...
        f"🛑  Price drops to ${a_stop} → exit same day, no waiting.",
        f"📅  Day before earnings → EXIT 100% at market close.",
        f"    Do this whether you are UP or DOWN — no exceptions.",
        f"    (Up $0.50? Sell. Down $0.50 and stop not hit? Still sell.)",
        f"    Never hold overnight into the announcement on Strategy A.",
        f"⏰  Still in trade {max(2, days_away - 1)}+ days later, nothing happened → exit, move on.",
        "",
        "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
